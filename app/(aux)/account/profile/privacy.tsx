      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            ...
            usamos seus dados e gerencie sua conta.
          </Text>
        </View>
        ...
        <View style={styles.item}>
          <View style={{ maxWidth: '80%' }}>
            ...
            <Text style={styles.itemSub}>
              Permitir uso dos dados de navegação para mostrar ofertas relevantes para você.
            </Text>
          </View>
        ...
        <View style={styles.item}>
          <View style={{ maxWidth: '80%' }}>
            ...
            <Text style={styles.itemSub}>
              Melhorar estimativa de frete e sugerir lojas próximas.
            </Text>
          </View>
