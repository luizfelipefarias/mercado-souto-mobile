...
export default function ProductDetails() {
  ...
  const handleBuy = () => {
    ...
    addToCart(itemToAdd);
    router.push('/(aux)/checkout' as any);
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.headerSafeArea}>
        <View style={styles.headerContent}>
          ...
          <TouchableOpacity style={styles.searchBarHeader} onPress={() => router.push('/(tabs)/home')}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/(aux)/cart' as any)}
          >
