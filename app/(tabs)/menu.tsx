...
import {
    View,
    StyleSheet,
    ScrollView, // 💡 Adicionamos 'ScrollView' diretamente
    TouchableOpacity,
    SafeAreaView,
    Platform,
    StatusBar,
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView 
                ...
                style={{ flex: 1 }} // 💡 Adicionamos flex: 1 aqui
            >
...
const styles = StyleSheet.create({
    ...
    scrollContent: { paddingHorizontal: 15, paddingBottom: 20 }, // Garantir padding inferior
    section: {
        backgroundColor: '#fff',
        borderRadius: 8,
        marginTop: 15, 
